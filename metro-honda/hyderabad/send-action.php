...
if (isset($_POST['btnSubmitData'])) {
    ...
    $validLocations = [
        "Sales" => ["Bowenpally", "Hyderabad", "Secunderabad"],
        "Service" => ["Bowenpally"]
    ];
    ...
    $query = "INSERT INTO honda (name, mobile, email,city, location, model, salesORservice) VALUES ('$name', '$mobile', '$email','$city', '$location', '$model', '$salesORservice')";
